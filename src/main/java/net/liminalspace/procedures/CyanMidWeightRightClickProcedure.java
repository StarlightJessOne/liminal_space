...
public class CyanMidWeightRightClickProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, BlockState blockstate, Entity entity) {
		if (entity == null)
			return;
		double random = 0;
		if (blockstate.getBlock() == LiminalSpaceModBlocks.MIDWEIGHT_ALGAE_CYAN_POOL_TILES.get() && (entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == Items.SHEARS) {
			...
			}
			{
				...
				BlockState _bs = LiminalSpaceModBlocks.LIGHT_ALGAE_CYAN_POOL_TILES.get().defaultBlockState();
